...
class AppSignals(QObject):
    ...
    SCANNING = Signal(name="scan_started")
    ...
    SCAN_DUPLICATES_PRESSED = Signal(name="scan_duplicates_pressed")
    STATUS_MESSAGE_SET = Signal(name="status_changed")
    MERGE_FOLDER_CHANGED = Signal(str, name="merge_folder_change")
    FOLDERS_TO_SCAN_CHANGED = Signal(dict, name="folders_to_scan_changed")
    RESULTS_ARRIVED = Signal(name="results_arrived")
